...
- На сторінці Оформлення приховуються зайві поля.
- Додана можливість розміщення полів Телефон та E-mail в дві колонки.
- Покращення UI/UX на сторінці налаштувань.
- Виправлення помилок.
