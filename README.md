...
Цей плагін додає метод доставки Делівері до вашого магазину WooCommerce, дозволяючи клієнтам вибирати регіон, місто та відділення для доставки своїх замовлень.
...
2. Розпакуйте архів та завантажте папку `wc-delivery-shipping` в директорію `/wp-content/plugins/` вашого сайту
3. Активуйте плагін через меню "Плагіни" в адміністративній панелі WordPress

## Налаштування

1. Перейдіть до розділу WooCommerce > Налаштування > Доставка
2. Натисніть на "Delivery Service"
...
4. Введіть отримані ключі в налаштування плагіну
...
Очистити кеш можна двома способами:

1. Через посилання "Clear Cache" на сторінці зі списком плагінів
2. Через кнопку "Clear Cache" безпосередньо на сторінці налаштувань плагіну (WooCommerce > Налаштування > Доставка > Delivery Service)
